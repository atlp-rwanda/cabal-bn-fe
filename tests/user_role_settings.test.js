...
import {getRolesAction} from '../src/redux/actions/user_role_settings.action'
import {assignRoleAction} from '../src/redux/actions/user_role_settings.action'
import MockAdapter from 'axios-mock-adapter';
import thunk from 'redux-thunk';
import configureStore from 'redux-mock-store';
import axios from 'axios';
import store from '../src/redux/store';
import { ASSIGNROLE, GETALLROLES } from '../src/redux/types/user_role_settings.types';
...
describe('USER_ROLE_SETTINGS TESTS', () => {
  ...
  it('should test user role settings reducer', async () => {
    ...
    expect(
      assignRoleReducer(initialState, {})
